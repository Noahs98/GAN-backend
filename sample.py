...
def main(args):
    ...
    generator.load_state_dict(torch.load(args.gen_path, map_location = lambda storage, loc:storage))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--image', type=str, default='./000000000880.jpg',
    ...
    parser.add_argument('--gen_path', type=str, default='./models/pretrained-generator-15-4000.pkl')
